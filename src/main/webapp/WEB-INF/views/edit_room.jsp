...
<head>
    ...
    <title>StudyMate - Chỉnh sửa nhóm</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="main-content">
                    <h5 class="mb-4"><i class="fas fa-edit"></i> Chỉnh sửa nhóm</h5>
                    <c:if test="${not empty error}">
                        <div class="alert alert-danger">${error}</div>
                    </c:if>
                    <form action="<c:url value='/rooms/${room.roomId}/edit'/>" method="post" class="card p-4">
                        <div class="mb-3">
